      ...
      <SwiperSlide>
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center bg-black bg-opacity-50 p-10 h-full w-full mx-0 rounded-lg">
            <h2 className="text-4xl text-white font-bold mb-4">Quality Education for All Ages</h2>
            <p className="text-white mb-8">Join our vibrant community of learners and educators.</p>
            <a href="#academics" className="bg-blue-500 text-white py-2 px-6 rounded-full hover:bg-blue-700">
              Explore Academics
            </a>
          </div>
        </div>
